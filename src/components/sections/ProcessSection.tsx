      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-16 md:text-center max-w-2xl md:mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground mb-4">
            {t.process.title1} <span className="text-primary">{t.process.titleHighlight}</span>
          </h2>
        ...
        <div className="grid gap-10 md:grid-cols-4 relative">
          ...
          {t.process.items.map((step, index) => (
            <div key={index} className="relative flex flex-col md:items-center md:text-center">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-white border-2 border-primary text-xl font-bold text-primary shadow-sm z-10 transition-transform hover:scale-110 duration-300">
                0{index + 1}
              </div>
